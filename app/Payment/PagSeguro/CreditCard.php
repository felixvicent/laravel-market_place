...
class CreditCard{
    ...
    public function doPayment(){
        ...
        foreach($this->items as $item){
            $creditCard->addItems()->withParameters($this->reference, $item['name'], $item['amount'], $item['price']);
        }
        ...
        $creditCard->setSender()->setDocument()->withParameters('CPF', '70152156402');
        ...
        $creditCard->setHolder()->setDocument()->withParameters('CPF', '70152156402');
